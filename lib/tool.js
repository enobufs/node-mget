...
function determinePortNumber(parsedUrl) {
    return parsedUrl.port? +parsedUrl.port : (parsedUrl.protocol === 'http:')? 80 : 443;
}

exports.getTimeLeftStr = getTimeLeftStr;
exports.getProgress = getProgress;
exports.determinePortNumber = determinePortNumber;
